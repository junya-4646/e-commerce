    ...
    <div class="w-tab-content">
      ...
      <div data-w-tab="Tab 1" class="w-tab-pane w--tab-active">
        <div class="w-layout-blockcontainer w-container">
          ...
          <div class="div-block-8">
            <a href="{{ route('admin.itemedit') }}" class="button-9 w-button">新規追加</a>
          </div>
        </div>
        <section>
          <x-itemlist_admin :products="$products" />
        </section>
      </div>
      ...
      <div data-w-tab="Tab 3" class="w-tab-pane">
        <div class="w-layout-blockcontainer w-container">
          ...
          <div class="div-block-8">
            <a href="{{ route('admin.useredit') }}" class="button-9 w-button">新規追加</a>
          </div>
        </div>
        <section>
          <x-userlist_admin :users="$users" :admins="$admins"/>
        </section>
      </div>
